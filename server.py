# OPENROUTER PATCH - replaces Gemini
import os as _orp
OPENROUTER_KEYS = [
    _orp.environ.get("OPENROUTER_KEY_1", "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"),
    _orp.environ.get("OPENROUTER_KEY_2", "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"),
    _orp.environ.get("OPENROUTER_KEY_3", "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"),
]
_or_index = 0
...
def call_llm(system_msg, user_msg, max_tokens=2000, temperature=0.2):
    ...
    global _or_index
    for _attempt in range(len(OPENROUTER_KEYS)):
        with _or_lock:
            _key = OPENROUTER_KEYS[_or_index % len(OPENROUTER_KEYS)]
        _headers = {
            "Authorization": "Bearer " + _key,
            "Content-Type": "application/json",
            "HTTP-Referer": "https://aurex-3d.up.railway.app",
            "X-Title": "AI 3D Studio"
        }
        _payload = {
